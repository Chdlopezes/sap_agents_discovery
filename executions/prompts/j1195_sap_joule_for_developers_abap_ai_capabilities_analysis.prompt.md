...
Localiza la fila del Identifier `J1195` en estas hojas del XLSX y anota las URLs:
...
```markdown
# Análisis caso de uso J1195 — SAP Joule for Developers‚ ABAP AI capabilities
