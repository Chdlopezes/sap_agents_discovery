# Ficha descriptiva de AI Feature — {{code}} · {{name}}
...
- **Producto:** {{product}}
- **Tipo de IA:** {{ai_type}}
- **Tipo comercial:** {{commercial_type}}
- **Disponibilidad:** {{availability}}
- **Detail Page (fuente principal):** {{detail_page}}
...
```bash
python scripts/fetch_sap_page.py "{{detail_page}}"
```
...
```
description/fichas/{{code_lower}}_{{slug}}_description.md
```
...
## Fuente
- SAP Discovery Center — Detail Page: {{detail_page}}
```
