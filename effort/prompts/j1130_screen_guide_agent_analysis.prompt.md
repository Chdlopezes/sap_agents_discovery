...
Analiza el caso de uso **J1130** — *Screen Guide Agent*.
...
Localiza la fila del Identifier `J1130` en estas hojas del XLSX y anota las URLs:
...
```markdown
# Análisis caso de uso J1130 — Screen Guide Agent
