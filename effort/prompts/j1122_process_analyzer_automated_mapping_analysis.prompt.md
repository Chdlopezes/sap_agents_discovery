...
Analiza el caso de uso **J1122** — *Process Analyzer‚ Automated Mapping*.
...
Localiza la fila del Identifier `J1122` en estas hojas del XLSX y anota las URLs:
...
```markdown
# Análisis caso de uso J1122 — Process Analyzer‚ Automated Mapping
