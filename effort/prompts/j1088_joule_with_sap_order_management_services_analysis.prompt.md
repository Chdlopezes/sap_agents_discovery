...
Analiza el caso de uso **J1088** — *Joule with SAP Order Management Services*.
...
Localiza la fila del Identifier `J1088` en estas hojas del XLSX y anota las URLs:
...
```markdown
# Análisis caso de uso J1088 — Joule with SAP Order Management Services
