# Ficha descriptiva de AI Feature — J1104 · Processing of Payment Advices with SAP Document AI
...
- **Identificador:** J1104
- **Nombre:** Processing of Payment Advices with SAP Document AI
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/988b6b7c-ac4f-4c5f-be46-0366c7dc5a2e/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/988b6b7c-ac4f-4c5f-be46-0366c7dc5a2e/"
```
...
```
description/fichas/j1104_processing_of_payment_advices_with_sap_document_ai_description.md
```
