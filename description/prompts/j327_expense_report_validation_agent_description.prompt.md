# Ficha descriptiva de AI Feature — J327 · Expense Report Validation Agent
...
- **Identificador:** J327
- **Nombre:** Expense Report Validation Agent
- **Producto:** No disponible
- **Tipo de IA:** AI Agent
- **Tipo comercial:** Base
- **Disponibilidad:** Early Adopter Care (EAC)
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/ba618aac-87c8-485d-8d3c-3338f6a8658a/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/ba618aac-87c8-485d-8d3c-3338f6a8658a/"
```
...
```
description/fichas/j327_expense_report_validation_agent_description.md
```
