# Ficha descriptiva de AI Feature — J756 · Safety Instruction Generation
...
- **Identificador:** J756
- **Nombre:** Safety Instruction Generation
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/76d64fc7-204e-4a1f-979c-2a75a7a4ce29/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/76d64fc7-204e-4a1f-979c-2a75a7a4ce29/"
```
...
```
description/fichas/j756_safety_instruction_generation_description.md
```
