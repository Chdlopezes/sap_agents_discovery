# Ficha descriptiva de AI Feature — J173 · Declaration Image Analysis
...
- **Identificador:** J173
- **Nombre:** Declaration Image Analysis
- **Producto:** SAP Green Token
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/ef9efdef-7300-4580-9c54-5664e1c99f95/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/ef9efdef-7300-4580-9c54-5664e1c99f95/"
```
...
```
description/fichas/j173_declaration_image_analysis_description.md
```
