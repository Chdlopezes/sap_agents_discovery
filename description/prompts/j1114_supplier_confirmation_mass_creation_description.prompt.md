# Ficha descriptiva de AI Feature — J1114 · Supplier Confirmation Mass Creation
...
- **Identificador:** J1114
- **Nombre:** Supplier Confirmation Mass Creation
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/b8dfd079-2d74-417a-ad38-8a5251110a4d/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/b8dfd079-2d74-417a-ad38-8a5251110a4d/"
```
...
```
description/fichas/j1114_supplier_confirmation_mass_creation_description.md
```
