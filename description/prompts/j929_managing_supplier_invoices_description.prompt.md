# Ficha descriptiva de AI Feature — J929 · Managing Supplier Invoices
...
- **Identificador:** J929
- **Nombre:** Managing Supplier Invoices
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/1fa927d7-80ce-4b9b-8ea1-8ed95be8b8d3/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/1fa927d7-80ce-4b9b-8ea1-8ed95be8b8d3/"
```
...
```
description/fichas/j929_managing_supplier_invoices_description.md
```
