# Ficha descriptiva de AI Feature — J162 · SAP Joule for Developers‚ ABAP AI capabilities
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/7f373198-9a41-4416-9eed-bdfca445d37a/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/7f373198-9a41-4416-9eed-bdfca445d37a/"
```
...
```
description/fichas/j162_sap_joule_for_developers_abap_ai_capabilities_description.md
```
