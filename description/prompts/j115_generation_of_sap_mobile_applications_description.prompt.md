# Ficha descriptiva de AI Feature — J115 · Generation of SAP Mobile Applications
...
- **Identificador:** J115
- **Nombre:** Generation of SAP Mobile Applications
- **Producto:** SAP Build Code
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/9cd6bb5e-4178-44c2-b5b3-325c561273e4/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/9cd6bb5e-4178-44c2-b5b3-325c561273e4/"
```
...
```
description/fichas/j115_generation_of_sap_mobile_applications_description.md
```
