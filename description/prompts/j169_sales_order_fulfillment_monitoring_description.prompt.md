# Ficha descriptiva de AI Feature — J169 · Sales Order Fulfillment Monitoring
...
- **Identificador:** J169
- **Nombre:** Sales Order Fulfillment Monitoring
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/16fe0c99-25ff-48e2-81e5-f100d4c64767/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/16fe0c99-25ff-48e2-81e5-f100d4c64767/"
```
...
```
description/fichas/j169_sales_order_fulfillment_monitoring_description.md
```
