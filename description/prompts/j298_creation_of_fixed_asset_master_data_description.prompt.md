# Ficha descriptiva de AI Feature — J298 · Creation of Fixed Asset Master Data
...
- **Identificador:** J298
- **Nombre:** Creation of Fixed Asset Master Data
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/095edf47-cb36-48d8-bd8f-9a4bc9517991/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/095edf47-cb36-48d8-bd8f-9a4bc9517991/"
```
...
```
description/fichas/j298_creation_of_fixed_asset_master_data_description.md
```
