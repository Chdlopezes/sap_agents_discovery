# Ficha descriptiva de AI Feature — J1684 · Enterprise Architecture Decision Management
...
- **Identificador:** J1684
- **Nombre:** Enterprise Architecture Decision Management
- **Producto:** SAP LeanIX solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/e9e98379-9c5f-4f4a-84f6-12a772c66ae2/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/e9e98379-9c5f-4f4a-84f6-12a772c66ae2/"
```
...
```
description/fichas/j1684_enterprise_architecture_decision_management_description.md
```
