# Ficha descriptiva de AI Feature — J934 · Smart Personalization of My Home for Applications
...
- **Identificador:** J934
- **Nombre:** Smart Personalization of My Home for Applications
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/2b5df257-bdfd-4396-a48b-a8362b2e02f7/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/2b5df257-bdfd-4396-a48b-a8362b2e02f7/"
```
...
```
description/fichas/j934_smart_personalization_of_my_home_for_applications_description.md
```
