# Ficha descriptiva de AI Feature — J151 · Master Data Governance
...
- **Identificador:** J151
- **Nombre:** Master Data Governance
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/4cb78833-492a-43db-abb2-01747e7e4335/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/4cb78833-492a-43db-abb2-01747e7e4335/"
```
...
```
description/fichas/j151_master_data_governance_description.md
```
