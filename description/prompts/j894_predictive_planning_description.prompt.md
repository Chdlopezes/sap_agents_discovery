# Ficha descriptiva de AI Feature — J894 · Predictive Planning
...
- **Identificador:** J894
- **Nombre:** Predictive Planning
- **Producto:** SAP Analytics Cloud
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/07cbfbe5-5fec-4f2f-9e5b-8a7c2dfd6d74/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/07cbfbe5-5fec-4f2f-9e5b-8a7c2dfd6d74/"
```
...
```
description/fichas/j894_predictive_planning_description.md
```
