# Ficha descriptiva de AI Feature — J846 · Sales Order Creation
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/451531fc-438b-4ecd-a3be-3efb74cb99f5/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/451531fc-438b-4ecd-a3be-3efb74cb99f5/"
```
...
```
description/fichas/j846_sales_order_creation_description.md
```
