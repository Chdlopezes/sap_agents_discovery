# Ficha descriptiva de AI Feature — J669 · Insights Description Generator
...
- **Identificador:** J669
- **Nombre:** Insights Description Generator
- **Producto:** SAP Signavio Process Transformation Manager
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/0614d66c-4e6d-42bc-b45b-135ba035d843/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/0614d66c-4e6d-42bc-b45b-135ba035d843/"
```
...
```
description/fichas/j669_insights_description_generator_description.md
```
