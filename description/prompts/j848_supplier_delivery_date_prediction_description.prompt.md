# Ficha descriptiva de AI Feature — J848 · Supplier Delivery Date Prediction
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/e0dd79ff-4ed9-4d79-9461-2be67e664a3c/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/e0dd79ff-4ed9-4d79-9461-2be67e664a3c/"
```
...
```
description/fichas/j848_supplier_delivery_date_prediction_description.md
```
