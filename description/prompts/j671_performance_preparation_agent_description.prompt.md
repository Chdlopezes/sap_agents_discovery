# Ficha descriptiva de AI Feature — J671 · Performance Preparation Agent
...
- **Identificador:** J671
- **Nombre:** Performance Preparation Agent
- **Producto:** No disponible
- **Tipo de IA:** AI Agent
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/761a2305-b0a2-4262-b9a3-abd4945ad314/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/761a2305-b0a2-4262-b9a3-abd4945ad314/"
```
...
```
description/fichas/j671_performance_preparation_agent_description.md
```
