# Ficha descriptiva de AI Feature — J28 · Goods Receipt Processing
...
- **Identificador:** J28
- **Nombre:** Goods Receipt Processing
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/8d54e237-4ae9-427d-859a-c3e1cd694127/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/8d54e237-4ae9-427d-859a-c3e1cd694127/"
```
...
```
description/fichas/j28_goods_receipt_processing_description.md
```
