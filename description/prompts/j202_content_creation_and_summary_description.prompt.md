# Ficha descriptiva de AI Feature — J202 · Content Creation and Summary
...
- **Identificador:** J202
- **Nombre:** Content Creation and Summary
- **Producto:** SAP Build Work Zone, advanced edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/39ef0f64-fc3b-4420-92ee-fa5e052d486b/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/39ef0f64-fc3b-4420-92ee-fa5e052d486b/"
```
...
```
description/fichas/j202_content_creation_and_summary_description.md
```
