# Ficha descriptiva de AI Feature — J117 · Form Extension in Localization as a Self-Service
...
- **Identificador:** J117
- **Nombre:** Form Extension in Localization as a Self-Service
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/f5f33f40-36d4-4265-b709-461c0c151587/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/f5f33f40-36d4-4265-b709-461c0c151587/"
```
...
```
description/fichas/j117_form_extension_in_localization_as_a_self_service_description.md
```
