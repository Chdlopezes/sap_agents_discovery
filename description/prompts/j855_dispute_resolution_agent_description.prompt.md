# Ficha descriptiva de AI Feature — J855 · Dispute Resolution Agent
...
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/bbf06e89-a47a-4a80-a619-97fa7ba6af92/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/bbf06e89-a47a-4a80-a619-97fa7ba6af92/"
```
...
```
description/fichas/j855_dispute_resolution_agent_description.md
```
