# Ficha descriptiva de AI Feature — J1284 · Document Data Extraction
...
- **Identificador:** J1284
- **Nombre:** Document Data Extraction
- **Producto:** SAP Build Process Automation
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/577af53b-83ac-4c49-8b02-72114d45ceb6/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/577af53b-83ac-4c49-8b02-72114d45ceb6/"
```
...
```
description/fichas/j1284_document_data_extraction_description.md
```
