# Ficha descriptiva de AI Feature — J358 · Processing of Incoming Quality Certificates with SAP Document AI
...
- **Identificador:** J358
- **Nombre:** Processing of Incoming Quality Certificates with SAP Document AI
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/3fd5ea00-34fa-487e-a76a-be112a71220a/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/3fd5ea00-34fa-487e-a76a-be112a71220a/"
```
...
```
description/fichas/j358_processing_of_incoming_quality_certificates_with_sap_document_ai_description.md
```
