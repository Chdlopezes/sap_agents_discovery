# Ficha descriptiva de AI Feature — J1122 · Process Analyzer‚ Automated Mapping
...
- **Identificador:** J1122
- **Nombre:** Process Analyzer‚ Automated Mapping
- **Producto:** SAP Signavio Process Intelligence
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/6c6eb8d1-764c-4727-b8d5-4911607f89b8/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/6c6eb8d1-764c-4727-b8d5-4911607f89b8/"
```
...
```
description/fichas/j1122_process_analyzer_automated_mapping_description.md
```
