# Ficha descriptiva de AI Feature — J415 · Sourcing Agent
...
- **Identificador:** J415
- **Nombre:** Sourcing Agent
- **Producto:** SAP Ariba Sourcing‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/944d71fe-90ad-4ef9-894c-878a4a326893/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/944d71fe-90ad-4ef9-894c-878a4a326893/"
```
...
```
description/fichas/j415_sourcing_agent_description.md
```
