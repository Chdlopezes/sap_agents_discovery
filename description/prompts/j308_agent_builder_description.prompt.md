# Ficha descriptiva de AI Feature — J308 · Agent Builder
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/c95490eb-95c3-4b0a-b9ea-08144355d482/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/c95490eb-95c3-4b0a-b9ea-08144355d482/"
```
...
```
description/fichas/j308_agent_builder_description.md
```
