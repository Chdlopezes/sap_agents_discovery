# Ficha descriptiva de AI Feature — J57 · Joule with SAP Business Technology Platform
...
- **Identificador:** J57
- **Nombre:** Joule with SAP Business Technology Platform
- **Producto:** SAP Business Technology Platform
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/9c079680-7938-4ddd-83c4-3d89a7943311/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/9c079680-7938-4ddd-83c4-3d89a7943311/"
```
...
```
description/fichas/j57_joule_with_sap_business_technology_platform_description.md
```
