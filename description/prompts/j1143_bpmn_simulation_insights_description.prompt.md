# Ficha descriptiva de AI Feature — J1143 · BPMN Simulation Insights
...
- **Identificador:** J1143
- **Nombre:** BPMN Simulation Insights
- **Producto:** SAP Signavio solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/45016b64-67d3-457e-a836-9ac08b193722/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/45016b64-67d3-457e-a836-9ac08b193722/"
```
...
```
description/fichas/j1143_bpmn_simulation_insights_description.md
```
