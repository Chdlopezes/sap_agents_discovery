# Ficha descriptiva de AI Feature — J47 · AI-Assisted Texting
...
- **Identificador:** J47
- **Nombre:** AI-Assisted Texting
- **Producto:** SAP LeanIX solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/86968b11-6426-4749-90c5-39d6711514a7/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/86968b11-6426-4749-90c5-39d6711514a7/"
```
...
```
description/fichas/j47_ai_assisted_texting_description.md
```
