# Ficha descriptiva de AI Feature — J108 · AI-Assisted Search
...
- **Identificador:** J108
- **Nombre:** AI-Assisted Search
- **Producto:** SAP Datasphere
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/68658ffa-898f-4e8d-888f-b48e3be618f5/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/68658ffa-898f-4e8d-888f-b48e3be618f5/"
```
...
```
description/fichas/j108_ai_assisted_search_description.md
```
