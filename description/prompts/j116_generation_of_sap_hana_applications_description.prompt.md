# Ficha descriptiva de AI Feature — J116 · Generation of SAP HANA Applications
...
- **Identificador:** J116
- **Nombre:** Generation of SAP HANA Applications
- **Producto:** SAP Build Code
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/7ee277ac-20af-4458-bb5a-8836d6a51899/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/7ee277ac-20af-4458-bb5a-8836d6a51899/"
```
...
```
description/fichas/j116_generation_of_sap_hana_applications_description.md
```
