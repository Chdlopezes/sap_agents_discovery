# Ficha descriptiva de AI Feature — J305 · Electronic Document Error Handling
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/1a1b66db-191d-41e6-b01d-d69b4d645850/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/1a1b66db-191d-41e6-b01d-d69b4d645850/"
```
...
```
description/fichas/j305_electronic_document_error_handling_description.md
```
