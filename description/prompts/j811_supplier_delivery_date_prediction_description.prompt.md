# Ficha descriptiva de AI Feature — J811 · Supplier Delivery Date Prediction
...
- **Identificador:** J811
- **Nombre:** Supplier Delivery Date Prediction
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/c264b09d-42ca-4256-8d8e-0da5af6c838a/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/c264b09d-42ca-4256-8d8e-0da5af6c838a/"
```
...
```
description/fichas/j811_supplier_delivery_date_prediction_description.md
```
