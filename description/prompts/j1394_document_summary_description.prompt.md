# Ficha descriptiva de AI Feature — J1394 · Document Summary
...
- **Identificador:** J1394
- **Nombre:** Document Summary
- **Producto:** SAP Cloud ALM
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/111df0da-5177-4769-88ea-6a200ecae091/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/111df0da-5177-4769-88ea-6a200ecae091/"
```
...
```
description/fichas/j1394_document_summary_description.md
```
