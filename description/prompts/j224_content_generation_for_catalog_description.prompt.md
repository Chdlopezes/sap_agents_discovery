# Ficha descriptiva de AI Feature — J224 · Content Generation for Catalog
...
- **Identificador:** J224
- **Nombre:** Content Generation for Catalog
- **Producto:** SAP Datasphere
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/15213c47-7c33-4787-a97b-d28f3a031c5a/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/15213c47-7c33-4787-a97b-d28f3a031c5a/"
```
...
```
description/fichas/j224_content_generation_for_catalog_description.md
```
