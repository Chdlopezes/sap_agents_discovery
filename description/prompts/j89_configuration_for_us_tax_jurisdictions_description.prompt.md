# Ficha descriptiva de AI Feature — J89 · Configuration for US Tax Jurisdictions
...
- **Identificador:** J89
- **Nombre:** Configuration for US Tax Jurisdictions
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/e547d658-368e-426f-986e-97e574bfb475/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/e547d658-368e-426f-986e-97e574bfb475/"
```
...
```
description/fichas/j89_configuration_for_us_tax_jurisdictions_description.md
```
