# Ficha descriptiva de AI Feature — J329 · Semantic Generation
...
- **Identificador:** J329
- **Nombre:** Semantic Generation
- **Producto:** SAP Datasphere
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/d22ae902-3e3d-4c78-9f8e-a656ecd2686d/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/d22ae902-3e3d-4c78-9f8e-a656ecd2686d/"
```
...
```
description/fichas/j329_semantic_generation_description.md
```
