# Ficha descriptiva de AI Feature — J212 · Process Analyzer‚ Text To Widget
...
- **Identificador:** J212
- **Nombre:** Process Analyzer‚ Text To Widget
- **Producto:** SAP Signavio solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/6d74c5e9-32c1-443c-be23-c7ebbc51d573/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/6d74c5e9-32c1-443c-be23-c7ebbc51d573/"
```
...
```
description/fichas/j212_process_analyzer_text_to_widget_description.md
```
