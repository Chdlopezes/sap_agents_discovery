# Ficha descriptiva de AI Feature — J470 · Data Actions
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/8e974edb-5d3e-4500-bc00-8549fbf8edd6/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/8e974edb-5d3e-4500-bc00-8549fbf8edd6/"
```
...
```
description/fichas/j470_data_actions_description.md
```
