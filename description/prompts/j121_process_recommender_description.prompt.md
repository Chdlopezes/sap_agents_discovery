# Ficha descriptiva de AI Feature — J121 · Process Recommender
...
- **Identificador:** J121
- **Nombre:** Process Recommender
- **Producto:** SAP Signavio solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/0568e3e9-bef3-46d5-8b51-f519d8838320/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/0568e3e9-bef3-46d5-8b51-f519d8838320/"
```
...
```
description/fichas/j121_process_recommender_description.md
```
