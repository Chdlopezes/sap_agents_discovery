# Ficha descriptiva de AI Feature — J148 · Analytical Insights
...
- **Identificador:** J148
- **Nombre:** Analytical Insights
- **Producto:** Joule
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/b354ca6f-3bbc-43d0-9c83-b3140b925962/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/b354ca6f-3bbc-43d0-9c83-b3140b925962/"
```
...
```
description/fichas/j148_analytical_insights_description.md
```
