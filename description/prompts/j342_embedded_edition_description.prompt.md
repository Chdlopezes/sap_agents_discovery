# Ficha descriptiva de AI Feature — J342 · Embedded Edition
...
- **Identificador:** J342
- **Nombre:** Embedded Edition
- **Producto:** SAP Document AI
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/f9000cc5-4a1a-4c59-9dcd-a343c167d75d/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/f9000cc5-4a1a-4c59-9dcd-a343c167d75d/"
```
...
```
description/fichas/j342_embedded_edition_description.md
```
