# Ficha descriptiva de AI Feature — J74 · Joule with SAP S/4HANA Cloud Public Edition
...
- **Identificador:** J74
- **Nombre:** Joule with SAP S/4HANA Cloud Public Edition
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/59d61974-9d59-4e32-9026-189462bbf54f/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/59d61974-9d59-4e32-9026-189462bbf54f/"
```
...
```
description/fichas/j74_joule_with_sap_s_4hana_cloud_public_edition_description.md
```
