# Ficha descriptiva de AI Feature — J642 · Decision Generation
...
- **Identificador:** J642
- **Nombre:** Decision Generation
- **Producto:** SAP Build Process Automation
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/0517fabc-df67-4042-9015-a57c1a9079ba/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/0517fabc-df67-4042-9015-a57c1a9079ba/"
```
...
```
description/fichas/j642_decision_generation_description.md
```
