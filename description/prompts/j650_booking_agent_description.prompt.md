# Ficha descriptiva de AI Feature — J650 · Booking Agent
...
- **Identificador:** J650
- **Nombre:** Booking Agent
- **Producto:** No disponible
- **Tipo de IA:** AI Agent
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/47844870-d3f6-4ffd-abdf-945d6bc20ae7/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/47844870-d3f6-4ffd-abdf-945d6bc20ae7/"
```
...
```
description/fichas/j650_booking_agent_description.md
```
