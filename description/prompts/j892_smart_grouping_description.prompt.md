# Ficha descriptiva de AI Feature — J892 · Smart Grouping
...
- **Identificador:** J892
- **Nombre:** Smart Grouping
- **Producto:** SAP Analytics Cloud
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/793c4da0-4886-4ee0-9c53-0bc2c465a624/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/793c4da0-4886-4ee0-9c53-0bc2c465a624/"
```
...
```
description/fichas/j892_smart_grouping_description.md
```
