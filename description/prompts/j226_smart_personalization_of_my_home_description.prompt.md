# Ficha descriptiva de AI Feature — J226 · Smart Personalization of My Home
...
- **Identificador:** J226
- **Nombre:** Smart Personalization of My Home
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/5205d1ac-b2a1-413b-8d5c-a01e22311cad/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/5205d1ac-b2a1-413b-8d5c-a01e22311cad/"
```
...
```
description/fichas/j226_smart_personalization_of_my_home_description.md
```
