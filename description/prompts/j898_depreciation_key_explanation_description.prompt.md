# Ficha descriptiva de AI Feature — J898 · Depreciation Key Explanation
...
- **Identificador:** J898
- **Nombre:** Depreciation Key Explanation
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/7f81035d-7177-494f-b232-b1e290c05f0c/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/7f81035d-7177-494f-b232-b1e290c05f0c/"
```
...
```
description/fichas/j898_depreciation_key_explanation_description.md
```
