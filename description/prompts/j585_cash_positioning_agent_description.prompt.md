# Ficha descriptiva de AI Feature — J585 · Cash Positioning Agent
...
- **Identificador:** J585
- **Nombre:** Cash Positioning Agent
- **Producto:** SAP S/4HANA Cloud Public Edition‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/cd99c7b2-f716-46ab-8fe5-640f9aa02613/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/cd99c7b2-f716-46ab-8fe5-640f9aa02613/"
```
...
```
description/fichas/j585_cash_positioning_agent_description.md
```
