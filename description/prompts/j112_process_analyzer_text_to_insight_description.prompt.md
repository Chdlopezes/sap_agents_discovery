# Ficha descriptiva de AI Feature — J112 · Process Analyzer‚ Text to Insight
...
- **Identificador:** J112
- **Nombre:** Process Analyzer‚ Text to Insight
- **Producto:** SAP Signavio solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/a6dde1d9-6da4-443f-874a-e6eb183e2bd5/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/a6dde1d9-6da4-443f-874a-e6eb183e2bd5/"
```
...
```
description/fichas/j112_process_analyzer_text_to_insight_description.md
```
