# Ficha descriptiva de AI Feature — J240 · In-house Service Initiation
...
- **Identificador:** J240
- **Nombre:** In-house Service Initiation
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/df0164e9-75f2-4547-80d3-586619709246/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/df0164e9-75f2-4547-80d3-586619709246/"
```
...
```
description/fichas/j240_in_house_service_initiation_description.md
```
