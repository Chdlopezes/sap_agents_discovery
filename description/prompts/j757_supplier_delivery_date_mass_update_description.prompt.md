# Ficha descriptiva de AI Feature — J757 · Supplier Delivery Date Mass Update
...
- **Identificador:** J757
- **Nombre:** Supplier Delivery Date Mass Update
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/d7b65dad-4fa1-4430-a860-6c8eba5ff8e1/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/d7b65dad-4fa1-4430-a860-6c8eba5ff8e1/"
```
...
```
description/fichas/j757_supplier_delivery_date_mass_update_description.md
```
