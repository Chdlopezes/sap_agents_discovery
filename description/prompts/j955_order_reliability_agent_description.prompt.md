# Ficha descriptiva de AI Feature — J955 · Order Reliability Agent
...
- **Identificador:** J955
- **Nombre:** Order Reliability Agent
- **Producto:** Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/51d0ed9c-7588-45e5-891d-44ef3ac456f5/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/51d0ed9c-7588-45e5-891d-44ef3ac456f5/"
```
...
```
description/fichas/j955_order_reliability_agent_description.md
```
