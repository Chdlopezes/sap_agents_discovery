# Ficha descriptiva de AI Feature — J832 · Sales Order Creation
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/836b7ca4-0177-4757-8152-51846c586f1e/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/836b7ca4-0177-4757-8152-51846c586f1e/"
```
...
```
description/fichas/j832_sales_order_creation_description.md
```
