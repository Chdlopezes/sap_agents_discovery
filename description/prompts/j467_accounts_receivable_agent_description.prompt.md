# Ficha descriptiva de AI Feature — J467 · Accounts Receivable Agent
...
- **Identificador:** J467
- **Nombre:** Accounts Receivable Agent
- **Producto:** Joule‚ SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/ecd030e9-59b3-43b4-85cf-260d498912dd/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/ecd030e9-59b3-43b4-85cf-260d498912dd/"
```
...
```
description/fichas/j467_accounts_receivable_agent_description.md
```
