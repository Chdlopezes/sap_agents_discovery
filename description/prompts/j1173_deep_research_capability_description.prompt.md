# Ficha descriptiva de AI Feature — J1173 · Deep Research Capability
...
- **Identificador:** J1173
- **Nombre:** Deep Research Capability
- **Producto:** Joule
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/0cbab727-02fe-47d3-9bf1-ff96d6c2ae62/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/0cbab727-02fe-47d3-9bf1-ff96d6c2ae62/"
```
...
```
description/fichas/j1173_deep_research_capability_description.md
```
