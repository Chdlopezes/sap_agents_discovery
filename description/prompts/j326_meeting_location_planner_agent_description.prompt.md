# Ficha descriptiva de AI Feature — J326 · Meeting Location Planner Agent
...
- **Identificador:** J326
- **Nombre:** Meeting Location Planner Agent
- **Producto:** No disponible
- **Tipo de IA:** AI Agent
- **Tipo comercial:** Base
- **Disponibilidad:** Early Adopter Care (EAC)
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/65b25edc-21cc-4b54-8f3c-eb4524ab3117/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/65b25edc-21cc-4b54-8f3c-eb4524ab3117/"
```
...
```
description/fichas/j326_meeting_location_planner_agent_description.md
```
