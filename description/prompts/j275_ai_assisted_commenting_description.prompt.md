# Ficha descriptiva de AI Feature — J275 · AI-Assisted Commenting
...
- **Identificador:** J275
- **Nombre:** AI-Assisted Commenting
- **Producto:** SAP Analytics Cloud
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/3a0d3a44-e0c6-42e9-b489-cbbd0c1d1030/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/3a0d3a44-e0c6-42e9-b489-cbbd0c1d1030/"
```
...
```
description/fichas/j275_ai_assisted_commenting_description.md
```
