# Ficha descriptiva de AI Feature — J243 · API traffic prediction
...
- **Identificador:** J243
- **Nombre:** API traffic prediction
- **Producto:** SAP Integration Suite
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/f74d29df-40d1-498f-905d-90b7af685799/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/f74d29df-40d1-498f-905d-90b7af685799/"
```
...
```
description/fichas/j243_api_traffic_prediction_description.md
```
