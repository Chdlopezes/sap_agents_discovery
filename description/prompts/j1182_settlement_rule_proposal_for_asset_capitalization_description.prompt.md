# Ficha descriptiva de AI Feature — J1182 · Settlement Rule Proposal for Asset Capitalization
...
- **Identificador:** J1182
- **Nombre:** Settlement Rule Proposal for Asset Capitalization
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/43cfa9f3-485c-4021-8dd1-e1349f471bea/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/43cfa9f3-485c-4021-8dd1-e1349f471bea/"
```
...
```
description/fichas/j1182_settlement_rule_proposal_for_asset_capitalization_description.md
```
