# Ficha descriptiva de AI Feature — J25 · Natural Language Query
...
- **Identificador:** J25
- **Nombre:** Natural Language Query
- **Producto:** SAP Analytics Cloud
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/6a655660-1f00-4b22-a6e4-b79167b527ec/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/6a655660-1f00-4b22-a6e4-b79167b527ec/"
```
...
```
description/fichas/j25_natural_language_query_description.md
```
