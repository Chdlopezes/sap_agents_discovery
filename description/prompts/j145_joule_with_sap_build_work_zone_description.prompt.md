# Ficha descriptiva de AI Feature — J145 · Joule with SAP Build Work Zone
...
- **Identificador:** J145
- **Nombre:** Joule with SAP Build Work Zone
- **Producto:** SAP Build Work Zone
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/8be96d98-f16d-41b4-968c-c295043c1d73/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/8be96d98-f16d-41b4-968c-c295043c1d73/"
```
...
```
description/fichas/j145_joule_with_sap_build_work_zone_description.md
```
