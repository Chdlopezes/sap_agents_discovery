# Ficha descriptiva de AI Feature — J468 · Field Service Dispatcher Agent
...
- **Identificador:** J468
- **Nombre:** Field Service Dispatcher Agent
- **Producto:** SAP Field Service Management‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/9c354ba9-b021-470a-b75d-b6e7bf4405de/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/9c354ba9-b021-470a-b75d-b6e7bf4405de/"
```
...
```
description/fichas/j468_field_service_dispatcher_agent_description.md
```
