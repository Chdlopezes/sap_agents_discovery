# Ficha descriptiva de AI Feature — J643 · Decision Summarization
...
- **Identificador:** J643
- **Nombre:** Decision Summarization
- **Producto:** SAP Build Process Automation
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/d9b9af67-e0a9-49cc-b79b-a8eddde1731b/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/d9b9af67-e0a9-49cc-b79b-a8eddde1731b/"
```
...
```
description/fichas/j643_decision_summarization_description.md
```
