# Ficha descriptiva de AI Feature — J1131 · Value Case Creation Agent
...
- **Identificador:** J1131
- **Nombre:** Value Case Creation Agent
- **Producto:** SAP Signavio Process Intelligence‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/e5f8f643-4dc9-46d4-96e6-15d73187869a/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/e5f8f643-4dc9-46d4-96e6-15d73187869a/"
```
...
```
description/fichas/j1131_value_case_creation_agent_description.md
```
