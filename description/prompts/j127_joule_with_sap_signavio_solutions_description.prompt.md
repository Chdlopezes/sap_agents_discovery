# Ficha descriptiva de AI Feature — J127 · Joule with SAP Signavio solutions
...
- **Identificador:** J127
- **Nombre:** Joule with SAP Signavio solutions
- **Producto:** SAP Signavio solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/c1ed93ca-2efd-4096-8300-613adf55cfef/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/c1ed93ca-2efd-4096-8300-613adf55cfef/"
```
...
```
description/fichas/j127_joule_with_sap_signavio_solutions_description.md
```
