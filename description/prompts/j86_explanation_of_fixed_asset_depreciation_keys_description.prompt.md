# Ficha descriptiva de AI Feature — J86 · Explanation of Fixed Asset Depreciation Keys
...
- **Identificador:** J86
- **Nombre:** Explanation of Fixed Asset Depreciation Keys
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/15f5b518-2786-4908-953f-801172d7972a/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/15f5b518-2786-4908-953f-801172d7972a/"
```
...
```
description/fichas/j86_explanation_of_fixed_asset_depreciation_keys_description.md
```
