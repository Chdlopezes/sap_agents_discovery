# Ficha descriptiva de AI Feature — J91 · Easy Filter
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/96cf54f4-566b-4428-916c-1e6231f0fdb2/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/96cf54f4-566b-4428-916c-1e6231f0fdb2/"
```
...
```
description/fichas/j91_easy_filter_description.md
```
