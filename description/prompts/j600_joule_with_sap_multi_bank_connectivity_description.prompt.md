# Ficha descriptiva de AI Feature — J600 · Joule with SAP Multi-Bank Connectivity
...
- **Identificador:** J600
- **Nombre:** Joule with SAP Multi-Bank Connectivity
- **Producto:** SAP Multi-Bank Connectivity
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/5cd6a2a6-c3ba-4bf6-9111-5e2f95757a69/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/5cd6a2a6-c3ba-4bf6-9111-5e2f95757a69/"
```
...
```
description/fichas/j600_joule_with_sap_multi_bank_connectivity_description.md
```
