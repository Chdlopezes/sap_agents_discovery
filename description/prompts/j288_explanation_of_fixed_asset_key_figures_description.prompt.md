# Ficha descriptiva de AI Feature — J288 · Explanation of Fixed Asset Key Figures
...
- **Identificador:** J288
- **Nombre:** Explanation of Fixed Asset Key Figures
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/8658cb4d-fc45-4db1-b5e3-68a63a255955/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/8658cb4d-fc45-4db1-b5e3-68a63a255955/"
```
...
```
description/fichas/j288_explanation_of_fixed_asset_key_figures_description.md
```
