# Ficha descriptiva de AI Feature — J741 · Catalog Optimization Agent
...
- **Identificador:** J741
- **Nombre:** Catalog Optimization Agent
- **Producto:** SAP CX AI Toolkit
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/28593981-f647-4d1b-bb1f-709783df1fa6/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/28593981-f647-4d1b-bb1f-709783df1fa6/"
```
...
```
description/fichas/j741_catalog_optimization_agent_description.md
```
