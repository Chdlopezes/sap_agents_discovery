# Ficha descriptiva de AI Feature — J291 · Joule with SAP Business Accelerator Hub
...
- **Identificador:** J291
- **Nombre:** Joule with SAP Business Accelerator Hub
- **Producto:** SAP Business Accelerator Hub
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/5b1c80e7-ae6a-45eb-89cf-cf7114bb00d4/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/5b1c80e7-ae6a-45eb-89cf-cf7114bb00d4/"
```
...
```
description/fichas/j291_joule_with_sap_business_accelerator_hub_description.md
```
