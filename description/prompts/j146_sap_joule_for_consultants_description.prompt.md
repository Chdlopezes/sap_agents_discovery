# Ficha descriptiva de AI Feature — J146 · SAP Joule for Consultants
...
- **Identificador:** J146
- **Nombre:** SAP Joule for Consultants
- **Producto:** SAP Joule for Consultants
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/3c3c6f7d-7310-47a9-ae52-d7ddd2f0c2f2/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/3c3c6f7d-7310-47a9-ae52-d7ddd2f0c2f2/"
```
...
```
description/fichas/j146_sap_joule_for_consultants_description.md
```
