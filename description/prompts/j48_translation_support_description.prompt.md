# Ficha descriptiva de AI Feature — J48 · Translation Support
...
- **Identificador:** J48
- **Nombre:** Translation Support
- **Producto:** SAP LeanIX solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/6719d6d7-fda7-4ea9-b0dd-43b99fbab6b6/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/6719d6d7-fda7-4ea9-b0dd-43b99fbab6b6/"
```
...
```
description/fichas/j48_translation_support_description.md
```
