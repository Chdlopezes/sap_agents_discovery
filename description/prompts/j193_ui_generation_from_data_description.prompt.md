# Ficha descriptiva de AI Feature — J193 · UI Generation from Data
...
- **Identificador:** J193
- **Nombre:** UI Generation from Data
- **Producto:** SAP Build Apps
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/691b7e82-b4ee-41f2-aae3-43b5b81be6f6/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/691b7e82-b4ee-41f2-aae3-43b5b81be6f6/"
```
...
```
description/fichas/j193_ui_generation_from_data_description.md
```
