# Ficha descriptiva de AI Feature — J92 · Generation of Integrations
...
- **Identificador:** J92
- **Nombre:** Generation of Integrations
- **Producto:** SAP Integration Suite
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/464fdfbe-5809-4a0a-b6e8-65c79033837d/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/464fdfbe-5809-4a0a-b6e8-65c79033837d/"
```
...
```
description/fichas/j92_generation_of_integrations_description.md
```
