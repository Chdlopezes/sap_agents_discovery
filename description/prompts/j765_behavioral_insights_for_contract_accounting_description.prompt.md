# Ficha descriptiva de AI Feature — J765 · Behavioral Insights for Contract Accounting
...
- **Identificador:** J765
- **Nombre:** Behavioral Insights for Contract Accounting
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/9b9439fc-3681-446c-989e-2540e2897331/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/9b9439fc-3681-446c-989e-2540e2897331/"
```
...
```
description/fichas/j765_behavioral_insights_for_contract_accounting_description.md
```
