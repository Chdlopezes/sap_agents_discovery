# Ficha descriptiva de AI Feature — J294 · Joule with SAP Datasphere
...
- **Identificador:** J294
- **Nombre:** Joule with SAP Datasphere
- **Producto:** SAP Datasphere
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Early Adopter Care (EAC)
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/a2bc2dd0-4f0b-4d82-9f94-c3baaac6c83b/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/a2bc2dd0-4f0b-4d82-9f94-c3baaac6c83b/"
```
...
```
description/fichas/j294_joule_with_sap_datasphere_description.md
```
