# Ficha descriptiva de AI Feature — J792 · SAP Joule for Developers‚ ABAP AI capabilities
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/3c06a28b-576b-47ba-a2be-de0588391d6a/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/3c06a28b-576b-47ba-a2be-de0588391d6a/"
```
...
```
description/fichas/j792_sap_joule_for_developers_abap_ai_capabilities_description.md
```
