# Ficha descriptiva de AI Feature — J762 · Joule and Microsoft 365 Copilot
...
- **Identificador:** J762
- **Nombre:** Joule and Microsoft 365 Copilot
- **Producto:** Joule
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/4dfa3fea-c5d2-40e3-959d-317b07b6b64e/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/4dfa3fea-c5d2-40e3-959d-317b07b6b64e/"
```
...
```
description/fichas/j762_joule_and_microsoft_365_copilot_description.md
```
