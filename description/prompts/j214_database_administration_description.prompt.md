# Ficha descriptiva de AI Feature — J214 · Database Administration
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/28b14ec8-e7be-4966-b33e-787021b2d05d/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/28b14ec8-e7be-4966-b33e-787021b2d05d/"
```
...
```
description/fichas/j214_database_administration_description.md
```
