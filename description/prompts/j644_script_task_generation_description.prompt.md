# Ficha descriptiva de AI Feature — J644 · Script Task Generation
...
- **Identificador:** J644
- **Nombre:** Script Task Generation
- **Producto:** SAP Build Process Automation
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/f2310927-98ed-410a-86bb-1ca9ece68e21/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/f2310927-98ed-410a-86bb-1ca9ece68e21/"
```
...
```
description/fichas/j644_script_task_generation_description.md
```
