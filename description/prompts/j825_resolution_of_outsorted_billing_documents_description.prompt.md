# Ficha descriptiva de AI Feature — J825 · Resolution of Outsorted Billing Documents
...
- **Identificador:** J825
- **Nombre:** Resolution of Outsorted Billing Documents
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/f9a4201e-955f-4aaf-b41a-d2479fb13ed1/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/f9a4201e-955f-4aaf-b41a-d2479fb13ed1/"
```
...
```
description/fichas/j825_resolution_of_outsorted_billing_documents_description.md
```
