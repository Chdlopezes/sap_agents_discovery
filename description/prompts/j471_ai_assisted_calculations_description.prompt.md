# Ficha descriptiva de AI Feature — J471 · AI-Assisted Calculations
...
- **Identificador:** J471
- **Nombre:** AI-Assisted Calculations
- **Producto:** SAP Analytics Cloud
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/b0112bf9-3bff-4991-b029-44248df82479/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/b0112bf9-3bff-4991-b029-44248df82479/"
```
...
```
description/fichas/j471_ai_assisted_calculations_description.md
```
