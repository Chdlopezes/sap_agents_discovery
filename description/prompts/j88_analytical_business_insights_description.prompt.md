# Ficha descriptiva de AI Feature — J88 · Analytical Business Insights
...
- **Identificador:** J88
- **Nombre:** Analytical Business Insights
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/864e421f-e2dd-4f84-9aad-ea57294f75fd/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/864e421f-e2dd-4f84-9aad-ea57294f75fd/"
```
...
```
description/fichas/j88_analytical_business_insights_description.md
```
