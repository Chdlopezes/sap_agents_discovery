# Ficha descriptiva de AI Feature — J535 · Central Governance
...
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/a0399e7f-e105-40a9-9169-d63e768735b8/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/a0399e7f-e105-40a9-9169-d63e768735b8/"
```
...
```
description/fichas/j535_central_governance_description.md
```
