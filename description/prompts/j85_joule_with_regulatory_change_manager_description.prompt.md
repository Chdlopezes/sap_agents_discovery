# Ficha descriptiva de AI Feature — J85 · Joule with Regulatory Change Manager
...
- **Identificador:** J85
- **Nombre:** Joule with Regulatory Change Manager
- **Producto:** Regulatory Change Manager
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/90b39e72-5dd5-4ae1-aef1-840c6e1ff6b2/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/90b39e72-5dd5-4ae1-aef1-840c6e1ff6b2/"
```
...
```
description/fichas/j85_joule_with_regulatory_change_manager_description.md
```
