# Ficha descriptiva de AI Feature — J180 · SAP HANA application migration
...
- **Identificador:** J180
- **Nombre:** SAP HANA application migration
- **Producto:** SAP HANA Cloud
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/14bbef6b-5d85-4221-bd0e-342f569ef628/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/14bbef6b-5d85-4221-bd0e-342f569ef628/"
```
...
```
description/fichas/j180_sap_hana_application_migration_description.md
```
