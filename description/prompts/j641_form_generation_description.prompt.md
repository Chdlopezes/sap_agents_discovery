# Ficha descriptiva de AI Feature — J641 · Form Generation
...
- **Identificador:** J641
- **Nombre:** Form Generation
- **Producto:** SAP Build Process Automation
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/ff9ca9a1-b443-405d-95bd-9b53a8a503db/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/ff9ca9a1-b443-405d-95bd-9b53a8a503db/"
```
...
```
description/fichas/j641_form_generation_description.md
```
