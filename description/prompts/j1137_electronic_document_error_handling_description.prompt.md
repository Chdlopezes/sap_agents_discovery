# Ficha descriptiva de AI Feature — J1137 · Electronic Document Error Handling
...
- **Identificador:** J1137
- **Nombre:** Electronic Document Error Handling
- **Producto:** SAP Document and Reporting Compliance
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/d755130d-328a-4e41-b5b8-b0f507ee396c/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/d755130d-328a-4e41-b5b8-b0f507ee396c/"
```
...
```
description/fichas/j1137_electronic_document_error_handling_description.md
```
