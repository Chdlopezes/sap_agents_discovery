# Ficha descriptiva de AI Feature — J648 · International Trade Classification Agent
...
- **Identificador:** J648
- **Nombre:** International Trade Classification Agent
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/cb3aa823-c475-4f81-9730-d35d85bd55c7/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/cb3aa823-c475-4f81-9730-d35d85bd55c7/"
```
...
```
description/fichas/j648_international_trade_classification_agent_description.md
```
