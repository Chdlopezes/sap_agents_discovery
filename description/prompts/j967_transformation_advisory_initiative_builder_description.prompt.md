# Ficha descriptiva de AI Feature — J967 · Transformation Advisory‚ Initiative Builder
...
- **Identificador:** J967
- **Nombre:** Transformation Advisory‚ Initiative Builder
- **Producto:** SAP Signavio solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/9ced0e83-412a-4e06-beda-6ef81e4bce95/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/9ced0e83-412a-4e06-beda-6ef81e4bce95/"
```
...
```
description/fichas/j967_transformation_advisory_initiative_builder_description.md
```
