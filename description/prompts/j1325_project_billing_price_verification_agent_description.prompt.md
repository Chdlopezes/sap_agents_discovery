# Ficha descriptiva de AI Feature — J1325 · Project Billing Price Verification Agent
...
- **Identificador:** J1325
- **Nombre:** Project Billing Price Verification Agent
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/540eb523-953a-43eb-8f93-525ee99d57fd/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/540eb523-953a-43eb-8f93-525ee99d57fd/"
```
...
```
description/fichas/j1325_project_billing_price_verification_agent_description.md
```
