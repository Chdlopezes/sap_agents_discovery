# Ficha descriptiva de AI Feature — J284 · Joule with SAP LeanIX
...
- **Identificador:** J284
- **Nombre:** Joule with SAP LeanIX
- **Producto:** SAP LeanIX solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Early Adopter Care (EAC)
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/afef2f21-b812-4548-ab8a-cec5f8fedb10/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/afef2f21-b812-4548-ab8a-cec5f8fedb10/"
```
...
```
description/fichas/j284_joule_with_sap_leanix_description.md
```
