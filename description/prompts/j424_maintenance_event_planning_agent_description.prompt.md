# Ficha descriptiva de AI Feature — J424 · Maintenance Event Planning Agent
...
- **Identificador:** J424
- **Nombre:** Maintenance Event Planning Agent
- **Producto:** Joule‚ SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/8b3daa3f-7a07-4a62-8d23-20e13d00aea4/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/8b3daa3f-7a07-4a62-8d23-20e13d00aea4/"
```
...
```
description/fichas/j424_maintenance_event_planning_agent_description.md
```
