# Ficha descriptiva de AI Feature — J195 · Skill Builder
...
- **Identificador:** J195
- **Nombre:** Skill Builder
- **Producto:** Joule Studio
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/e93aa292-e7f4-449d-9586-f1a8510d5ab6/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/e93aa292-e7f4-449d-9586-f1a8510d5ab6/"
```
...
```
description/fichas/j195_skill_builder_description.md
```
