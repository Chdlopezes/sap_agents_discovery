# Ficha descriptiva de AI Feature — J1195 · SAP Joule for Developers‚ ABAP AI capabilities
...
- **Identificador:** J1195
- **Nombre:** SAP Joule for Developers‚ ABAP AI capabilities
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/795cf9fa-d0cc-42b0-a3d7-52e8067e847d/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/795cf9fa-d0cc-42b0-a3d7-52e8067e847d/"
```
...
```
description/fichas/j1195_sap_joule_for_developers_abap_ai_capabilities_description.md
```
