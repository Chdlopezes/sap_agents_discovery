# Ficha descriptiva de AI Feature — J241 · Maintenance Order Recommendation
...
- **Identificador:** J241
- **Nombre:** Maintenance Order Recommendation
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/d2a47a4f-3ea2-4f5b-9bdf-43fc2a3d95f2/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/d2a47a4f-3ea2-4f5b-9bdf-43fc2a3d95f2/"
```
...
```
description/fichas/j241_maintenance_order_recommendation_description.md
```
