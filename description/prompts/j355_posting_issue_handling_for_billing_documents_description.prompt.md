# Ficha descriptiva de AI Feature — J355 · Posting Issue Handling for Billing Documents
...
- **Identificador:** J355
- **Nombre:** Posting Issue Handling for Billing Documents
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/f558354e-8de3-4b95-ae75-4cc5055cf911/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/f558354e-8de3-4b95-ae75-4cc5055cf911/"
```
...
```
description/fichas/j355_posting_issue_handling_for_billing_documents_description.md
```
