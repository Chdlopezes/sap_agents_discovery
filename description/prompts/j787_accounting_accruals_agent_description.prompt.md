# Ficha descriptiva de AI Feature — J787 · Accounting Accruals Agent
...
- **Identificador:** J787
- **Nombre:** Accounting Accruals Agent
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/2ba6ab3e-ff22-4cb6-b3b4-20613ae8f6e3/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/2ba6ab3e-ff22-4cb6-b3b4-20613ae8f6e3/"
```
...
```
description/fichas/j787_accounting_accruals_agent_description.md
```
