# Ficha descriptiva de AI Feature — J404 · Sales Order Creation from Unstructured Data
...
- **Identificador:** J404
- **Nombre:** Sales Order Creation from Unstructured Data
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/ffd1d0b2-76fc-4e1f-b1fd-523ec82bae54/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/ffd1d0b2-76fc-4e1f-b1fd-523ec82bae54/"
```
...
```
description/fichas/j404_sales_order_creation_from_unstructured_data_description.md
```
