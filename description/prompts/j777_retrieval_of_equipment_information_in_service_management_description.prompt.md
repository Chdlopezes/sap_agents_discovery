# Ficha descriptiva de AI Feature — J777 · Retrieval of Equipment Information in Service Management
...
- **Identificador:** J777
- **Nombre:** Retrieval of Equipment Information in Service Management
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/3de36a16-73ca-4df6-94d2-ccd0dc806192/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/3de36a16-73ca-4df6-94d2-ccd0dc806192/"
```
...
```
description/fichas/j777_retrieval_of_equipment_information_in_service_management_description.md
```
