# Ficha descriptiva de AI Feature — J139 · Chart Summary
...
- **Identificador:** J139
- **Nombre:** Chart Summary
- **Producto:** SAP Analytics Cloud
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/825764c4-6de1-4789-bd0c-74243c60854b/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/825764c4-6de1-4789-bd0c-74243c60854b/"
```
...
```
description/fichas/j139_chart_summary_description.md
```
