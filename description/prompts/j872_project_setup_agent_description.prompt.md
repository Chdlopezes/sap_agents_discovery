# Ficha descriptiva de AI Feature — J872 · Project Setup Agent
...
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/49c08b5c-583b-4108-ba23-401c3da051cf/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/49c08b5c-583b-4108-ba23-401c3da051cf/"
```
...
```
description/fichas/j872_project_setup_agent_description.md
```
