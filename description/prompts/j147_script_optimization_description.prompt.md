# Ficha descriptiva de AI Feature — J147 · Script Optimization
...
- **Identificador:** J147
- **Nombre:** Script Optimization
- **Producto:** SAP Integration Suite
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/99357ead-1ee2-4b9d-9b2f-f74d10f09262/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/99357ead-1ee2-4b9d-9b2f-f74d10f09262/"
```
...
```
description/fichas/j147_script_optimization_description.md
```
