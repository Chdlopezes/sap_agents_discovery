# Ficha descriptiva de AI Feature — J1003 · Allocation Run Results
...
- **Identificador:** J1003
- **Nombre:** Allocation Run Results
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/58e5fdf9-b00a-414b-97ef-74c65c21b10b/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/58e5fdf9-b00a-414b-97ef-74c65c21b10b/"
```
...
```
description/fichas/j1003_allocation_run_results_description.md
```
