# Ficha descriptiva de AI Feature — J1132 · Dashboard Analyzer Agent
...
- **Identificador:** J1132
- **Nombre:** Dashboard Analyzer Agent
- **Producto:** SAP Signavio Process Intelligence‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/251eb6f4-4565-4ac7-8e6c-f5eb6df7d210/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/251eb6f4-4565-4ac7-8e6c-f5eb6df7d210/"
```
...
```
description/fichas/j1132_dashboard_analyzer_agent_description.md
```
