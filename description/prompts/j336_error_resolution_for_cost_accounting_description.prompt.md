# Ficha descriptiva de AI Feature — J336 · Error Resolution for Cost Accounting
...
- **Identificador:** J336
- **Nombre:** Error Resolution for Cost Accounting
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/56d1e4d0-5c07-4aa8-b226-64c8dd99750d/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/56d1e4d0-5c07-4aa8-b226-64c8dd99750d/"
```
...
```
description/fichas/j336_error_resolution_for_cost_accounting_description.md
```
