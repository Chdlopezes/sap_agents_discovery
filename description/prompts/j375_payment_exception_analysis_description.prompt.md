# Ficha descriptiva de AI Feature — J375 · Payment Exception Analysis
...
- **Identificador:** J375
- **Nombre:** Payment Exception Analysis
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/016c719c-5363-47ff-945f-cdddd5241871/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/016c719c-5363-47ff-945f-cdddd5241871/"
```
...
```
description/fichas/j375_payment_exception_analysis_description.md
```
