# Ficha descriptiva de AI Feature — J425 · Cash Positioning Agent
...
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/61f9300e-11e0-4ca2-acee-ace35c44fae0/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/61f9300e-11e0-4ca2-acee-ace35c44fae0/"
```
...
```
description/fichas/j425_cash_positioning_agent_description.md
```
