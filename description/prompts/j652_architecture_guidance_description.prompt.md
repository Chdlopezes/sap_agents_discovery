# Ficha descriptiva de AI Feature — J652 · Architecture Guidance
...
- **Identificador:** J652
- **Nombre:** Architecture Guidance
- **Producto:** SAP LeanIX solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/5b68ce3e-c6d7-4e5d-a2cd-e137adb01d33/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/5b68ce3e-c6d7-4e5d-a2cd-e137adb01d33/"
```
...
```
description/fichas/j652_architecture_guidance_description.md
```
