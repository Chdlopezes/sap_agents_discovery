# Ficha descriptiva de AI Feature — J1129 · Workspace Administration Agent
...
- **Identificador:** J1129
- **Nombre:** Workspace Administration Agent
- **Producto:** SAP Signavio Process Collaboration Hub‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/d8e34c50-6983-4129-aa44-3356bf2fb4bf/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/d8e34c50-6983-4129-aa44-3356bf2fb4bf/"
```
...
```
description/fichas/j1129_workspace_administration_agent_description.md
```
