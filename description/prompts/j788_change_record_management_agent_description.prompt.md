# Ficha descriptiva de AI Feature — J788 · Change Record Management Agent
...
- **Identificador:** J788
- **Nombre:** Change Record Management Agent
- **Producto:** Joule‚ SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/905534ac-4ede-4c01-a815-476a1643ac7c/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/905534ac-4ede-4c01-a815-476a1643ac7c/"
```
...
```
description/fichas/j788_change_record_management_agent_description.md
```
