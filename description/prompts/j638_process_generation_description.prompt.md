# Ficha descriptiva de AI Feature — J638 · Process Generation
...
- **Identificador:** J638
- **Nombre:** Process Generation
- **Producto:** SAP Build Process Automation
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/50a434ab-f63c-4f3f-a5d2-c661b5d461f2/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/50a434ab-f63c-4f3f-a5d2-c661b5d461f2/"
```
...
```
description/fichas/j638_process_generation_description.md
```
