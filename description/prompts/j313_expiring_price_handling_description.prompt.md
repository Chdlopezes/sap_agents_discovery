# Ficha descriptiva de AI Feature — J313 · Expiring Price Handling
...
- **Identificador:** J313
- **Nombre:** Expiring Price Handling
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/577815a8-947e-4a06-a961-1307ddc49242/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/577815a8-947e-4a06-a961-1307ddc49242/"
```
...
```
description/fichas/j313_expiring_price_handling_description.md
```
