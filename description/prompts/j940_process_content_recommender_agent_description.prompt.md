# Ficha descriptiva de AI Feature — J940 · Process Content Recommender Agent
...
- **Identificador:** J940
- **Nombre:** Process Content Recommender Agent
- **Producto:** Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/aa94ac46-bbb3-405e-a7f9-1e14e9bc16db/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/aa94ac46-bbb3-405e-a7f9-1e14e9bc16db/"
```
...
```
description/fichas/j940_process_content_recommender_agent_description.md
```
