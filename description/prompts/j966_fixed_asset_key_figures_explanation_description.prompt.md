# Ficha descriptiva de AI Feature — J966 · Fixed Asset Key Figures Explanation
...
- **Identificador:** J966
- **Nombre:** Fixed Asset Key Figures Explanation
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/780e16a7-74cf-4118-b200-c13484d2f9b5/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/780e16a7-74cf-4118-b200-c13484d2f9b5/"
```
...
```
description/fichas/j966_fixed_asset_key_figures_explanation_description.md
```
