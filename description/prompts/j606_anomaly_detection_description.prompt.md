# Ficha descriptiva de AI Feature — J606 · Anomaly Detection
...
- **Identificador:** J606
- **Nombre:** Anomaly Detection
- **Producto:** SAP Integration Suite
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/c1bf4c86-b2bc-4101-b51d-bc5904ff5924/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/c1bf4c86-b2bc-4101-b51d-bc5904ff5924/"
```
...
```
description/fichas/j606_anomaly_detection_description.md
```
