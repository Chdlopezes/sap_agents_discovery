# Ficha descriptiva de AI Feature — J120 · Performance Indicators Recommender
...
- **Identificador:** J120
- **Nombre:** Performance Indicators Recommender
- **Producto:** SAP Signavio solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/4be4b091-a23d-4f59-975e-65cb6a4a8fc5/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/4be4b091-a23d-4f59-975e-65cb6a4a8fc5/"
```
...
```
description/fichas/j120_performance_indicators_recommender_description.md
```
