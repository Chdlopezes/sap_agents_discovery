# Ficha descriptiva de AI Feature — J345 · Compliance Information Processing
...
- **Identificador:** J345
- **Nombre:** Compliance Information Processing
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/57f00cc9-d292-4fd6-baec-cb4a6336c70c/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/57f00cc9-d292-4fd6-baec-cb4a6336c70c/"
```
...
```
description/fichas/j345_compliance_information_processing_description.md
```
