# Ficha descriptiva de AI Feature — J778 · Requirement Generation
...
- **Identificador:** J778
- **Nombre:** Requirement Generation
- **Producto:** SAP Cloud ALM
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/e5701d25-2615-49ad-acf3-4f2a6363a206/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/e5701d25-2615-49ad-acf3-4f2a6363a206/"
```
...
```
description/fichas/j778_requirement_generation_description.md
```
