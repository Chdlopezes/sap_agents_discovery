# Ficha descriptiva de AI Feature — J54 · Joule with SAP S/4HANA Cloud Private Edition
...
- **Identificador:** J54
- **Nombre:** Joule with SAP S/4HANA Cloud Private Edition
- **Producto:** SAP S/4HANA Cloud Private Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/98ee8608-82bb-49c3-b4ca-805bd6594314/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/98ee8608-82bb-49c3-b4ca-805bd6594314/"
```
...
```
description/fichas/j54_joule_with_sap_s_4hana_cloud_private_edition_description.md
```
