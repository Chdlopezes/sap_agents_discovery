# Ficha descriptiva de AI Feature — J1130 · Screen Guide Agent
...
- **Identificador:** J1130
- **Nombre:** Screen Guide Agent
- **Producto:** SAP Signavio Process Collaboration Hub‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/1be89884-5087-4293-9b9e-da35987fe9bc/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/1be89884-5087-4293-9b9e-da35987fe9bc/"
```
...
```
description/fichas/j1130_screen_guide_agent_description.md
```
