# Ficha descriptiva de AI Feature — J383 · Production Planning and Operations Agent
...
- **Identificador:** J383
- **Nombre:** Production Planning and Operations Agent
- **Producto:** SAP S/4HANA Cloud Public Edition‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/2bac78a3-811f-456f-b950-a4fb3e7d2ac5/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/2bac78a3-811f-456f-b950-a4fb3e7d2ac5/"
```
...
```
description/fichas/j383_production_planning_and_operations_agent_description.md
```
