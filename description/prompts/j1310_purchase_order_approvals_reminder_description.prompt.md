# Ficha descriptiva de AI Feature — J1310 · Purchase Order Approvals Reminder
...
- **Identificador:** J1310
- **Nombre:** Purchase Order Approvals Reminder
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/13b68daa-1ba2-4bfa-b7d3-4f65f4900d07/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/13b68daa-1ba2-4bfa-b7d3-4f65f4900d07/"
```
...
```
description/fichas/j1310_purchase_order_approvals_reminder_description.md
```
