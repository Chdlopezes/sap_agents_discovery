# Ficha descriptiva de AI Feature — J178 · Inventory Builder
...
- **Identificador:** J178
- **Nombre:** Inventory Builder
- **Producto:** SAP LeanIX solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/3b4cd740-d09d-4e79-9efc-69bf49221e83/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/3b4cd740-d09d-4e79-9efc-69bf49221e83/"
```
...
```
description/fichas/j178_inventory_builder_description.md
```
