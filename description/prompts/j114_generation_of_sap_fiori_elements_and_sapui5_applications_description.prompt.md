# Ficha descriptiva de AI Feature — J114 · Generation of SAP Fiori Elements and SAPUI5 Applications
...
- **Identificador:** J114
- **Nombre:** Generation of SAP Fiori Elements and SAPUI5 Applications
- **Producto:** SAP Build Code
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/08cc63b7-8fd7-4535-a9d6-f66a9030174c/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/08cc63b7-8fd7-4535-a9d6-f66a9030174c/"
```
...
```
description/fichas/j114_generation_of_sap_fiori_elements_and_sapui5_applications_description.md
```
