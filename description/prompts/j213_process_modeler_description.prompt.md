# Ficha descriptiva de AI Feature — J213 · Process Modeler
...
- **Identificador:** J213
- **Nombre:** Process Modeler
- **Producto:** SAP Signavio solutions
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Premium
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/84eb743d-acdb-48ff-b933-ec51fe9f5f12/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/84eb743d-acdb-48ff-b933-ec51fe9f5f12/"
```
...
```
description/fichas/j213_process_modeler_description.md
```
