# Ficha descriptiva de AI Feature — J87 · Error Resolution
...
- **Identificador:** J87
- **Nombre:** Error Resolution
- **Producto:** SAP Advanced Financial Closing
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/942e1e4b-32e0-480f-9f11-d31badf54186/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/942e1e4b-32e0-480f-9f11-d31badf54186/"
```
...
```
description/fichas/j87_error_resolution_description.md
```
