# Ficha descriptiva de AI Feature — J1043 · Dispute Resolution Agent
...
- **Identificador:** J1043
- **Nombre:** Dispute Resolution Agent
- **Producto:** SAP S/4HANA Cloud Public Edition‚ Joule
- **Tipo de IA:** AI Agent
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/d3a94887-d357-4620-98d5-784a035f9e41/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/d3a94887-d357-4620-98d5-784a035f9e41/"
```
...
```
description/fichas/j1043_dispute_resolution_agent_description.md
```
