# Ficha descriptiva de AI Feature — J831 · Sales Order Creation
...
- **Identificador:** J831
- **Nombre:** Sales Order Creation
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/5d3d1312-92d7-478a-8e95-f0f0130f5666/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/5d3d1312-92d7-478a-8e95-f0f0130f5666/"
```
...
```
description/fichas/j831_sales_order_creation_description.md
```
