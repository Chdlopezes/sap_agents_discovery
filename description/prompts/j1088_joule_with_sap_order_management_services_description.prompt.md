# Ficha descriptiva de AI Feature — J1088 · Joule with SAP Order Management Services
...
- **Identificador:** J1088
- **Nombre:** Joule with SAP Order Management Services
- **Producto:** SAP Order Management Services
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/b9498c45-6944-48e3-bb0e-902c71bef176/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/b9498c45-6944-48e3-bb0e-902c71bef176/"
```
...
```
description/fichas/j1088_joule_with_sap_order_management_services_description.md
```
