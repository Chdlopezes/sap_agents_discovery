# Ficha descriptiva de AI Feature — J1047 · Sales Order Status Check
...
- **Identificador:** J1047
- **Nombre:** Sales Order Status Check
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/8e12da05-b0e4-490f-9cf4-0cc2a9482f71/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/8e12da05-b0e4-490f-9cf4-0cc2a9482f71/"
```
...
```
description/fichas/j1047_sales_order_status_check_description.md
```
