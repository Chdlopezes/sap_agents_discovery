# Ficha descriptiva de AI Feature — J43 · Sales Order Automatic Completion
...
- **Identificador:** J43
- **Nombre:** Sales Order Automatic Completion
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/39a49e49-3ab6-46f5-889d-2035d9378cab/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/39a49e49-3ab6-46f5-889d-2035d9378cab/"
```
...
```
description/fichas/j43_sales_order_automatic_completion_description.md
```
