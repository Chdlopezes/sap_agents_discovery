# Ficha descriptiva de AI Feature — J172 · 2D Hotspot Creation
...
- **Identificador:** J172
- **Nombre:** 2D Hotspot Creation
- **Producto:** SAP Integrated Product Development
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/c523c267-0a3d-4430-9cba-e75df8caac1b/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/c523c267-0a3d-4430-9cba-e75df8caac1b/"
```
...
```
description/fichas/j172_2d_hotspot_creation_description.md
```
