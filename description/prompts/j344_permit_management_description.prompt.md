# Ficha descriptiva de AI Feature — J344 · Permit Management
...
- **Identificador:** J344
- **Nombre:** Permit Management
- **Producto:** SAP S/4HANA Cloud Public Edition
- **Tipo de IA:** AI Feature
- **Tipo comercial:** No disponible
- **Disponibilidad:** Beta
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/89944fea-d96d-453c-9684-fe2b2c9cbb51/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/89944fea-d96d-453c-9684-fe2b2c9cbb51/"
```
...
```
description/fichas/j344_permit_management_description.md
```
