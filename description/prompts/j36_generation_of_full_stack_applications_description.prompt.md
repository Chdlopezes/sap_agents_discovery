# Ficha descriptiva de AI Feature — J36 · Generation of Full-Stack Applications
...
- **Identificador:** J36
- **Nombre:** Generation of Full-Stack Applications
- **Producto:** SAP Build Code
- **Tipo de IA:** AI Feature
- **Tipo comercial:** Base
- **Disponibilidad:** Generally Available
- **Detail Page (fuente principal):** https://discovery-center.cloud.sap/ai-feature/98319fdc-fd0d-4887-bba2-a3d6a15f31ed/
...
```bash
python scripts/fetch_sap_page.py "https://discovery-center.cloud.sap/ai-feature/98319fdc-fd0d-4887-bba2-a3d6a15f31ed/"
```
...
```
description/fichas/j36_generation_of_full_stack_applications_description.md
```
